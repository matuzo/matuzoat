...
The more JavaScript we add to our page, the more fragile our interface gets and the more we have to manage and communicate manually, if we want to create [equal experiences for all](https://inclusivedesignprinciples.org/#provide-comparable-experience) (Hint: That's something we definitely want).
