...
teaser: "Subgrid allows a grid-item with its own grid to align with its parent grid  (currently only in [Firefox 71+ and Safari 16+](https://caniuse.com/css-subgrid))."
tags:
  - blog
  - posts
  - css
